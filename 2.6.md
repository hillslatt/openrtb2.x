...
<table>
  ...
  <tr>
    ...
    <td>Video placement type for the impression. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list--placement-subtypes---video-">List: Placement Subtypes - Video</a> in AdCOM 1.0.</td>
	 ...
	 <tr>
    <td><code>plcmnt</code></td>
    <td>integer</td>
    <td>Video placement type for the impression. Refer to values 6+ from <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list--placement-subtypes---video-">List: Placement Subtypes - Video</a> in AdCOM 1.0.</td>
  </tr>
  <tr>
